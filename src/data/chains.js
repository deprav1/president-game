...
export const CHAINS = {
  ...
  ds_arc_2_blockade: {
    ...
    card: {
      advisor: 3, // Сенин
      text: "Сенин докладывает: блокировка Наружу провалена. Миллионы граждан перешли на новые VPN. Екатерина Пиздулина требует Чебунет.",
  ...
  ds_arc_2_open: {
    ...
    card: {
      advisor: 4, // Сара Хартли
      text: "Хартли: свободный интернет в Варонии привлек западных инвесторов. Арсрамление Лебеда предлагает открыть IT-хаб.",
