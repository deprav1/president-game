...
export const ADVISORS = [
  { name: "Эльвира Сахипзадовна", role: "Глава Центробанка",       avatar: "/images/advisor_vlasova.png"  }, // 0 (Финансовый блок, таргетирование инфляции)
  ...
  { name: "Дмитрий Песков",      role: "Пресс-секретарь президента", avatar: "/images/advisor_zubov.png"  }, // 2 (Пресс-служба, усы, озабоченность)
