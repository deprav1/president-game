...
export const ADVISORS = [
  { name: "Аркадий Зубов", role: "Глава Центробанка",       avatar: "/images/Zubov_Finance.webp"  }, // 0 (Финансовый блок, таргетирование инфляции)
  { name: "Генерал Валерий Громов", role: "Глава Генерального штаба", avatar: "/images/Gromov_Military.webp" }, // 1 (Военное ведомство, контракты, снаряды)
  { name: "Елена Власова",      role: "Пресс-секретарь президента", avatar: "/images/Vlasova_Press.webp"  }, // 2 (Пресс-служба, озабоченность)
  ...
  { name: "Борис Усманов",       role: "Олигарх №1",             avatar: "/images/Usmanov_Oligarch.webp"  }, // 7 (Олигархический конгломерат, яхты, VK)
];
