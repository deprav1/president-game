...
export const ADVISORS = [
  { name: "Аркадий Зубов", role: "Глава Центробанка",       avatar: "/images/advisor_zubov.png"  }, // 0 (Финансовый блок, таргетирование инфляции)
  ...
  { name: "Елена Власова",      role: "Пресс-секретарь президента", avatar: "/images/advisor_vlasova.png"  }, // 2 (Пресс-служба, озабоченность)
  { name: "Николай Сенин",    role: "Секретарь Совета Безопасности", avatar: "/images/advisor_senin.png" }, // 3 (Спецслужбы, теории заговоров, боевые гуси)
  { name: "Посол Сара Хартли",   role: "Посол Коллективного Запада", avatar: "/images/advisor_ambassador.png" }, // 4 (Представитель Запада, санкции)
