...
const THEME_BACKGROUNDS = [
  ...
  { bg: "/images/bg_event_hospital_corridor_vert.webp", words: ["медицин", "больниц", "здрав", "койк", "ивл", "грипп", "врач", "медсестр", "поликлиник"] },
  ...
  { bg: "/images/bg_event_tv_studio_vert.webp", words: ["пресс", "тв", "телеканал", "эфир", "трансляц", "прямая линия", "журналист", "власова"] },
  ...
  { bg: "/images/bg_event_bank_hall_vert.webp", words: ["рубл", "банк", "бюджет", "инфляц", "налог", "мвф", "fitch", "тариф", "ставк", "зубов", "платеж", "платёж"] },
  { bg: "/images/bg_crypto_basement_exchange.webp", words: ["крипт", "биткоин", "кошелек", "кошелёк", "майнинг", "валют", "обнал", "санкц"] },
  { bg: "/images/bg_event_ministry_corridor_vert.webp", words: ["министерств", "министр", "ведомств", "чиновник", "бюрократ", "кабмин", "аппарат", "департамент", "согласован", "регламент"] },
